...
def display_main_menu(user: User) -> None:
    ...
    from version_one.welcome_menu import display_welcome_menu
    from version_one.transaction_services import TransactionServices
    from version_one.account_library import AccountLibrary
